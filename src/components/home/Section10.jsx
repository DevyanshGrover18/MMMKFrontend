...
const CinematicVideoPlayer = ({ videoSrc, isImage, imageSrc, isActive }) => {
  ...
  return (
    ...
    >
      ...
      {/* Mute button (only active on center card and for video) */}
      {isActive && !isImage && (
        <button
          onClick={toggleMute}
            ...
            <SwiperSlide key={i} className="flex justify-center pb-10">
              {({ isActive }) => (
                <CinematicVideoPlayer 
                  videoSrc={`/influencerVideo${i + 1}.mp4`} 
                  isActive={isActive} 
                />
              )}
            </SwiperSlide>
          ))}
          <SwiperSlide key="influencer-image" className="flex justify-center pb-10">
            {({ isActive }) => (
              <CinematicVideoPlayer 
                isImage={true}
                imageSrc="/influencerImage1.jpg"
                isActive={isActive} 
              />
            )}
          </SwiperSlide>
