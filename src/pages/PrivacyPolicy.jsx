      ...
      <main className="relative z-10 px-5 py-16 text-white md:px-20 md:py-24">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-12 space-y-12 text-base leading-8 text-white/80 md:text-lg">
            ...
            {/* Information We Collect — 3 sub-sections in 2-col grid */}
            ...
            {/* Payment — paragraph only, single col */}
            <section className="space-y-3">
            ...
            {/* Marketing + Cookies — side by side */}
            ...
            {/* Sharing Information — 2 sub-sections in 2-col grid */}
            <section className="space-y-6">
            ...
            {/* Data Retention + Your Rights — side by side */}
            <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
              <section className="space-y-3">
            ...
            {/* Children's + Third-Party + Changes — 3-col grid */}
